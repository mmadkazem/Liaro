        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MobileLoginExpire = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    LastLoggedIn = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                    SerialNumber = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefreshTokenIdHash = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
                    RefreshTokenIdHashSource = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: true),
